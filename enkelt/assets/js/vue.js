Vue.component('app-table', {
	props: ['ths', 'tbody', 'search_model', 'title'],
	template: `
		<div class="table-responsive">
                     <table class="table">
                            <thead>
                                  <tr>
                                          <th v-for="th in ths" v-text="th"></th>
                                  </tr>
                            </thead>
                            <tbody v-for="tr in tbody">
                                 <tr>
                                          <th v-text="tr.title"></th>
...
Vue.component('app-callout', {
	props: ['title', 'type', 'body', 'icon'],
	template: `
		<div :class="'callout-block callout-'+type">
                     <div class="icon-holder">
                            <em :class="icon"></em>
                     </div><!--//icon-holder-->
                     <div class="content">
                            <h4 class="callout-title" v-text="title"></h4>
                            <h5 v-html="body"></h5>
                     </div><!--//content-->
             </div>
	`
...
Vue.component('app-code-example', {
	props: ['lines', 'output', 'title', 'description'],
	template: `
		<div>
			<br>
			<h4 v-text="title"></h4>
			...
			<div class="code-block" style="line-height: 1px;">
				<code>
			             <div class="code-block" v-for="(line, index) in lines">
			                     <code><em style="color: lightgray" v-text="String(index+1)+' '" style="padding-right: 10px"></em><code v-text="line" :style="'padding-left: ' + get_amount_of_indent(line)"></code></code>
			             </div>
		             </code>
	             </div>
	             <h5>Utdata</h5>
	             <div class="code-block" style="line-height: 1px;">
	                     <code>
			             <div class="code-block" v-for="line in output">
			                     <code v-text="line"></code>
			             </div>
		             </code>
	             </div>
             </div>
	`,
	methods: {
		get_amount_of_indent: function(line) {
			let x = 0;
			...
			return String(x * 5) + 'px';
			
		}
	}
});

Vue.component('app-page-header', {
	props: ['title'],
	template: `
		<header id="header" class="header">
             <div class="container">
                     <div class="branding">
                            <h1 class="logo">
                                  <a href="index.html">
                                          <span class="text-highlight">Enkelt</span>
                                          <span class="text-bold"><img src="/favicon.png" height="60px" width="60px" alt="Enkelt"></span>
                                  </a>
                            </h1>
                     </div>
                     <!--//branding-->
                     <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" v-text="title"></li>
                     </ol>
             </div>
             <!--//container-->
      </header>
	...
	template: `
		<footer class="footer text-center">
			<div class="container">
				...
				<a href="https://www.gdprprivacynotice.com/live.php?token=0IXB1XWbNZdpWuZzBjKGWDXlDyLAhLdK" class="iubenda-black iubenda-embed" title="Privacy Policy ">Privacy Policy</a>
			</div><!--//container-->
		</footer><!--//footer-->
	`
});

Vue.component('app-footer-img', {
	data: function () {
		return {
	...
	template: `
		<img :src="src" :alt="alt" id="logo_res">
	`
});
...
Vue.component('app-app', {
	data: function () {
		return {
			link: 'https://play.google.com/store/apps/details?id=io.buscedv.enkelt',
		}
	},
	template: `
		<div class="content-holder col-lg-7 col-md-6 col-12" style="margin-left: auto; margin-right: auto; text-align: center; width: 100%;">
...
let app = new Vue({
	el: '#app',
	computed: {
		filtered_keyword_table: function() {
